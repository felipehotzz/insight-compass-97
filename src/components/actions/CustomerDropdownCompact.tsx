  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <button className="flex items-center justify-between gap-2 w-full h-8 px-3 rounded-md border border-border/50 bg-transparent hover:bg-muted/50 transition-colors text-left text-xs text-muted-foreground">
